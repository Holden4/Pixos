...
/***/ function(module, exports, __webpack_require__) {
	...
	var LIBRARY            = __webpack_require__(321)
	  ...
	  , anInstance         = __webpack_require__(459)
	  , forOf              = __webpack_require__(460)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _battle = __webpack_require__(468);
	
	var _Battle = __webpack_require__(477);
	...
	var mapDispatchToProps = {
	  increment: function increment() {
	    return (0, _battle.increment)(1);
	  },
	  doubleAsync: _battle.doubleAsync,
	  setupPlayers: _battle.setupPlayers,
	  setTurnFinished: _battle.setTurnFinished,
	  setMyTurn: _battle.setMyTurn,
	  updateEnemyState: _battle.updateEnemyState,
	  passTurn: _battle.passTurn,
	  removeCard: _battle.removeCard,
	  addCard: _battle.addCard,
	  updatePower: _battle.updatePower
	};
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Battle2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.actions = exports.doubleAsync = exports.UPDATE_POWER = exports.ADD_CARD = exports.REMOVE_CARD = exports.PASS_TURN = exports.UPDATE_ENEMY_STATE = exports.SET_MY_TURN = exports.SET_TURN_FINISHED = exports.PLAY_CARD = exports.SET_PLAYER_PASS = exports.SET_NEXT_PLAYER = exports.SETUP_PLAYERS = exports.BATTLE_DOUBLE_ASYNC = exports.BATTLE_INCREMENT = undefined;
	
	var _defineProperty2 = __webpack_require__(455);
	
	var _defineProperty3 = _interopRequireDefault(_defineProperty2);
	
	var _values = __webpack_require__(469);
	
	var _values2 = _interopRequireDefault(_values);
	
	var _getIterator2 = __webpack_require__(473);
	...
	var _promise = __webpack_require__(456);
	...
	exports.setTurnFinished = setTurnFinished;
	exports.setMyTurn = setMyTurn;
	exports.passTurn = passTurn;
	exports.updateEnemyState = updateEnemyState;
	exports.default = battleReducer;
	
	var _initialBattleState = __webpack_require__(476);
	...
	// Constants
	// ------------------------------------
	var BATTLE_INCREMENT = exports.BATTLE_INCREMENT = 'BATTLE_INCREMENT';
	var BATTLE_DOUBLE_ASYNC = exports.BATTLE_DOUBLE_ASYNC = 'BATTLE_DOUBLE_ASYNC';
	var SETUP_PLAYERS = exports.SETUP_PLAYERS = 'SETUP_PLAYERS';
	var SET_NEXT_PLAYER = exports.SET_NEXT_PLAYER = 'SET_NEXT_PLAYER';
	var SET_PLAYER_PASS = exports.SET_PLAYER_PASS = 'SET_PLAYER_PASS';
	var PLAY_CARD = exports.PLAY_CARD = 'PLAY_CARD';
	var SET_TURN_FINISHED = exports.SET_TURN_FINISHED = 'SET_TURN_FINISHED';
	var SET_MY_TURN = exports.SET_MY_TURN = 'SET_MY_TURN';
	var UPDATE_ENEMY_STATE = exports.UPDATE_ENEMY_STATE = 'UPDATE_ENEMY_STATE';
	var PASS_TURN = exports.PASS_TURN = 'PASS_TURN';
	var REMOVE_CARD = exports.REMOVE_CARD = 'REMOVE_CARD';
	var ADD_CARD = exports.ADD_CARD = 'ADD_CARD';
	var UPDATE_POWER = exports.UPDATE_POWER = 'UPDATE_POWER';
	...
	function setTurnFinished(boolean) {
	  return {
	...
	function updateEnemyState(object) {
	  return {
	...
	// Action Handlers
	// ------------------------------------
	var ACTION_HANDLERS = (_ACTION_HANDLERS = {}, (0, _defineProperty3.default)(_ACTION_HANDLERS, BATTLE_INCREMENT, function (state, action) {
	  return state + action.payload;
	}), (0, _defineProperty3.default)(_ACTION_HANDLERS, BATTLE_DOUBLE_ASYNC, function (state, action) {
	  return state * 2;
	}), (0, _defineProperty3.default)(_ACTION_HANDLERS, SETUP_PLAYERS, function (state, action) {
	  return (0, _assign2.default)({}, state, {
	    self: (0, _assign2.default)({}, state.self, {
	      hand: action.payload.selfHand,
	      myTurn: action.payload.selfTurn,
	      name: action.payload.selfName
	    }),
	    enemy: (0, _assign2.default)({}, state.enemy, {
	      hand: action.payload.enemyHand,
	      name: action.payload.enemyName
	    })
	  });
	}), (0, _defineProperty3.default)(_ACTION_HANDLERS, SET_TURN_FINISHED, function (state, action) {
	  return (0, _assign2.default)({}, state, {
	    turnFinished: action.payload
	  });
	}), (0, _defineProperty3.default)(_ACTION_HANDLERS, PASS_TURN, function (state, action) {
	  return (0, _assign2.default)({}, state, {
	    self: (0, _assign2.default)({}, state.self, {
	      hasPassed: action.payload
	    })
	  });
	}), (0, _defineProperty3.default)(_ACTION_HANDLERS, SET_MY_TURN, function (state, action) {
	  return (0, _assign2.default)({}, state, {
	    self: (0, _assign2.default)({}, state.self, {
	      myTurn: action.payload
	    })
	  });
	}), (0, _defineProperty3.default)(_ACTION_HANDLERS, ADD_CARD, function (state, action) {
	  var card = state.self.hand[action.payload];
	  console.log(card);
	  console.log(card.type);
	  if (card.type == 'water') {
	    state.self.playingArea.water.push(card);
	  } else if (card.type == 'land') {
	    state.self.playingArea.land.push(card);
	  } else {
	    state.self.playingArea.air.push(card);
	  }
	...
	}), (0, _defineProperty3.default)(_ACTION_HANDLERS, REMOVE_CARD, function (state, action) {
	...
	}), (0, _defineProperty3.default)(_ACTION_HANDLERS, UPDATE_ENEMY_STATE, function (state, action) {
	  return (0, _assign2.default)({}, state, {
	    enemy: action.payload
	  });
	}), (0, _defineProperty3.default)(_ACTION_HANDLERS, UPDATE_POWER, function (state, action) {
	  var enemyPower = 0;
	  ...
	  try {
	    for (var _iterator = (0, _getIterator3.default)((0, _values2.default)(state.enemy.playingArea)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	  ...
	  try {
	    for (var _iterator2 = (0, _getIterator3.default)((0, _values2.default)(state.self.playingArea)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	      var _array = _step2.value;
	
	      _array.forEach(function (card) {
	...
	// Reducer
	// ------------------------------------
	var initialState = _initialBattleState.INITIAL_STATE;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(5)
	  , $values = __webpack_require__(472)(false);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InfoBar = __webpack_require__(478);
	
	var _InfoBar2 = _interopRequireDefault(_InfoBar);
	
	var _Board = __webpack_require__(567);
	
	var _Board2 = _interopRequireDefault(_Board);
	
	var _CircularProgress = __webpack_require__(582);
	
	var _CircularProgress2 = _interopRequireDefault(_CircularProgress);
	
	var _socket = __webpack_require__(584);
	...
	var Battle = function (_React$Component) {
	  (0, _inherits3.default)(Battle, _React$Component);
	
	  function Battle() {
	    (0, _classCallCheck3.default)(this, Battle);
	    return (0, _possibleConstructorReturn3.default)(this, (Battle.__proto__ || (0, _getPrototypeOf2.default)(Battle)).apply(this, arguments));
	  }
	    ...
	    value: function loadContent() {
	      if (this.props.battle.self.hand.length == 0) {
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(_InfoBar2.default, { battle: this.props.battle,
	            setTurnFinished: this.props.setTurnFinished,
	            setMyTurn: this.props.setMyTurn,
	            passTurn: this.props.passTurn
	          }),
	          _react2.default.createElement(_Board2.default, { battle: this.props.battle,
	            setTurnFinished: this.props.setTurnFinished,
	            setMyTurn: this.props.setMyTurn,
	...
	Battle.propTypes = {
	  setupPlayers: _react2.default.PropTypes.func.isRequired,
	  setTurnFinished: _react2.default.PropTypes.func.isRequired,
	  doubleAsync: _react2.default.PropTypes.func.isRequired,
	  increment: _react2.default.PropTypes.func.isRequired,
	  battle: _react2.default.PropTypes.object.isRequired,
	  setMyTurn: _react2.default.PropTypes.func.isRequired,
	  updateEnemyState: _react2.default.PropTypes.func.isRequired,
	  passTurn: _react2.default.PropTypes.func.isRequired,
	  removeCard: _react2.default.PropTypes.func.isRequired,
	  addCard: _react2.default.PropTypes.func.isRequired,
	  updatePower: _react2.default.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InfoBar = function (_React$Component) {
	  (0, _inherits3.default)(InfoBar, _React$Component);
	
	  function InfoBar(props) {
	    (0, _classCallCheck3.default)(this, InfoBar);
	
	    var _this = (0, _possibleConstructorReturn3.default)(this, (InfoBar.__proto__ || (0, _getPrototypeOf2.default)(InfoBar)).call(this, props));
	
	    _this.setTurnFinishedToTrue = _this.setTurnFinishedToTrue.bind(_this);
	    return _this;
	  }
	
	  (0, _createClass3.default)(InfoBar, [{
	    key: 'setTurnFinishedToTrue',
	    value: function setTurnFinishedToTrue() {
	    ...
	    value: function loadContent() {
	      if (this.props.battle.self.myTurn) {
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(_RaisedButton2.default, { label: 'Pass', primary: true, onTouchTap: this.setTurnFinishedToTrue })
	        );
	      } else {
	        return _react2.default.createElement(
	          'p',
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'info-bar col-1 d-flex flex-column justify-content-center align-items-center pt-2 pb-4' },
	        _react2.default.createElement(_PixosMenu2.default, null),
	        _react2.default.createElement(
	          'p',
	          { className: 'mb-auto' },
	          this.props.battle.enemy.name
	        ),
	        _react2.default.createElement(
	          'h3',
	          { className: 'my-2' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Hand = __webpack_require__(568);
	
	var _Hand2 = _interopRequireDefault(_Hand);
	
	var _PlayingArea = __webpack_require__(578);
	...
	var Board = function (_React$Component) {
	  ...
	  (0, _createClass3.default)(Board, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'board col-11' },
	        _react2.default.createElement(_Hand2.default, { hand: this.props.battle.enemy.hand,
	          removeCard: this.props.removeCard,
	          addCard: this.props.addCard,
	          isEnemyHand: true }),
	        _react2.default.createElement(_PlayingArea.PlayingArea, { type: 'enemy', cardArrays: this.props.battle.enemy.playingArea }),
	        _react2.default.createElement('hr', { className: 'm-0' }),
	        _react2.default.createElement(_PlayingArea.PlayingArea, { type: 'self', cardArrays: this.props.battle.self.playingArea }),
	        _react2.default.createElement(_Hand2.default, { hand: this.props.battle.self.hand,
	          removeCard: this.props.removeCard,
	          setTurnFinished: this.props.setTurnFinished,
	          setMyTurn: this.props.setMyTurn,
	          addCard: this.props.addCard,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CardWrapper = __webpack_require__(569);
	...
	var _HiddenCard = __webpack_require__(573);
	
	var _HiddenCard2 = _interopRequireDefault(_HiddenCard);
	...
	var Hand = function (_React$Component) {
	  (0, _inherits3.default)(Hand, _React$Component);
	
	  function Hand() {
	    (0, _classCallCheck3.default)(this, Hand);
	    return (0, _possibleConstructorReturn3.default)(this, (Hand.__proto__ || (0, _getPrototypeOf2.default)(Hand)).apply(this, arguments));
	  }
	
	  (0, _createClass3.default)(Hand, [{
	    key: 'renderHandComponents',
	    value: function renderHandComponents() {
	      var _this2 = this;
	
	      if (this.props.isEnemyHand) {
	        return this.props.hand.map(function (card, i) {
	          return _react2.default.createElement(_HiddenCard2.default, (0, _extends3.default)({ key: i }, card));
	        });
	      } else {
	        return this.props.hand.map(function (card, i) {
	          if (_this2.props.isSelfTurn) {
	            return _react2.default.createElement(_CardWrapper2.default, (0, _extends3.default)({ key: i }, card, {
	              removeCard: _this2.props.removeCard,
	              addCard: _this2.props.addCard,
	              setTurnFinished: _this2.props.setTurnFinished,
	              setMyTurn: _this2.props.setMyTurn,
	              id: i,
	              updatePower: _this2.props.updatePower }));
	          } else {
	            return _react2.default.createElement(_Card2.default, (0, _extends3.default)({ key: i }, card, {
	              id: i }));
	          }
	        });
	      }
	    ...
	    key: 'loadContent',
	    value: function loadContent() {
	      var cards = this.renderHandComponents();
	      var owner = this.props.isEnemyHand ? 'enemy' : 'self';
	      return _react2.default.createElement(
	        'div',
	        { className: 'd-flex flex-wrap justify-content-center px-2 py-2 ' + owner + '-hand-border' },
	        cards
	      );
	    }
	  }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CardWrapper = function (_React$Component) {
	  (0, _inherits3.default)(CardWrapper, _React$Component);
	
	  function CardWrapper(props) {
	    (0, _classCallCheck3.default)(this, CardWrapper);
	
	    var _this = (0, _possibleConstructorReturn3.default)(this, (CardWrapper.__proto__ || (0, _getPrototypeOf2.default)(CardWrapper)).call(this, props));
	    ...
	    _this.handleTouchTap = _this.handleTouchTap.bind(_this);
	    _this.handleRequestClose = _this.handleRequestClose.bind(_this);
	    _this.playCard = _this.playCard.bind(_this);
	    _this.setTurnFinishedToTrue = _this.setTurnFinishedToTrue.bind(_this);
	    return _this;
	  }
	
	  (0, _createClass3.default)(CardWrapper, [{
	    key: 'setTurnFinishedToTrue',
	    value: function setTurnFinishedToTrue() {
	      this.props.setMyTurn(false);
	      this.props.setTurnFinished(true);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _Menu2.default,
	            null,
	            _react2.default.createElement(_MenuItem2.default, { primaryText: 'Play', onClick: this.playCard })
	          )
	        )
	      );
	    }
	...
	var Card = function (_React$Component) {
	  ...
	  (0, _createClass3.default)(Card, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'game-card box-shadow mx-1 ' + this.props.type + '-faint-bkgrnd d-flex align-items-stretch' },
	        _react2.default.createElement(
	          'div',
	          { className: 'game-card-name-holder pb-1 ' + this.props.type + '-main-bkgrnd' },
	          _react2.default.createElement(
	            'h4',
	            { className: 'game-card-name m-0 text-left highlighted-white-text' },
	            this.props.name.charAt(0).toUpperCase() + this.props.name.slice(1)
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'd-flex justify-content-center align-items-start game-card-img-holder p-1' },
	          _react2.default.createElement('img', { className: 'game-card-img', src: this.props.imgUrl, alt: 'Card image cap' })
	        ),
	        _react2.default.createElement(
	          'span',
	          { className: 'game-card-power ' + this.props.type + '-bkgrnd circle d-inline-block mx-auto highlighted-white-text' },
	          this.props.power
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(true) {
		...
		if(!content.locals) {
			module.hot.accept(572, function() {
				var newContent = __webpack_require__(572);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".game-card-name{font-size:.6rem;transform:rotate(-90deg);transform-origin:left bottom 0;position:absolute;bottom:3px;left:11px;max-width:85px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.game-card{width:76px;height:90px;position:relative;border-radius:5px}.game-card-img-holder{min-height:62px;width:76px}.game-card-name-holder{position:relative;width:14px}.game-card-img{max-width:100%;max-height:100%}.game-card-power{width:24px;height:24px;font-size:.9rem;line-height:1.8;position:absolute;bottom:3px;left:15px}", "", {"version":3,"sources":["/./src/routes/Battle/components/src/routes/Battle/components/Card.scss"],"names":[],"mappings":"AAAA,gBACE,gBAAiB,yBACQ,+BACM,kBACb,WACP,UACD,eACK,uBACQ,mBACJ,eACH,CACjB,WAGC,WAAW,YACC,kBACM,iBACA,CACnB,sBAIC,gBAAgB,UACL,CACZ,uBAGC,kBAAkB,UACP,CACZ,eAGC,eAAe,eACC,CACjB,iBAGC,WAAW,YACC,gBACK,gBACD,kBACE,WACP,SACD,CACX","file":"Card.scss","sourcesContent":[".game-card-name {\n  font-size: 0.6rem;\n  transform: rotate(-90deg);\n  transform-origin: left bottom 0;\n  position: absolute;\n  bottom: 3px;\n  left: 11px;\n  max-width: 85px;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  overflow: hidden;\n}\n\n.game-card {\n  width: 76px;\n  height: 90px;\n  position: relative;\n  border-radius: 5px;\n}\n\n\n.game-card-img-holder {\n  min-height: 62px;\n  width: 76px;\n}\n\n.game-card-name-holder {\n  position: relative;\n  width: 14px;\n}\n\n.game-card-img {\n  max-width: 100%;\n  max-height: 100%;\n}\n\n.game-card-power {\n  width: 24px;\n  height: 24px;\n  font-size: 0.9rem;\n  line-height: 1.8;\n  position: absolute;\n  bottom: 3px;\n  left: 15px;\n}\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HiddenCard = exports.HiddenCard = function HiddenCard(props) {
	  return _react2.default.createElement(
	    'div',
	    { className: 'px-2 py-4 mx-1 box-shadow game-card grey-faint-bkgrnd' },
	    _react2.default.createElement(
	      'div',
	      { className: 'd-flex justify-content-center align-items-center hidden-card-img-holder' },
	      _react2.default.createElement('img', { className: 'card-img-top game-card-img', src: '/img/card-reverse-dino.svg', alt: 'Card image cap' })
	    )
	  );
	};
	
	exports.default = HiddenCard;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".hidden-card-img-holder{height:100%;width:100%}", "", {"version":3,"sources":["/./src/routes/Battle/components/src/routes/Battle/components/HiddenCard.scss"],"names":[],"mappings":"AAAA,wBACE,YAAY,UACD,CACZ","file":"HiddenCard.scss","sourcesContent":[".hidden-card-img-holder {\n  height: 100%;\n  width: 100%;\n}\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".self-hand-border{border-top:5px solid #474747;margin-top:10px}.enemy-hand-border{border-bottom:5px solid #474747;margin-bottom:10px}", "", {"version":3,"sources":["/./src/routes/Battle/components/src/routes/Battle/components/Hand.scss"],"names":[],"mappings":"AAEA,kBACE,6BAH4B,eAIZ,CACjB,mBAGC,gCAR4B,kBAST,CACpB","file":"Hand.scss","sourcesContent":["$border-color: rgb(71, 71, 71);\n\n.self-hand-border {\n  border-top: 5px solid $border-color;\n  margin-top: 10px;\n}\n\n.enemy-hand-border {\n  border-bottom: 5px solid $border-color;\n  margin-bottom: 10px;\n}\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.PlayingArea = undefined;
	
	var _react = __webpack_require__(24);
	
	var _react2 = _interopRequireDefault(_react);
	
	var _BattleRow = __webpack_require__(579);
	
	var _BattleRow2 = _interopRequireDefault(_BattleRow);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var PlayingArea = exports.PlayingArea = function PlayingArea(props) {
	  return _react2.default.createElement(
	    'div',
	    { className: 'playing-area' },
	    _react2.default.createElement(_BattleRow2.default, { type: props.type == 'enemy' ? 'air' : 'land',
	      cards: props.type == 'enemy' ? props.cardArrays.air : props.cardArrays.land
	    }),
	    _react2.default.createElement('hr', { className: 'm-0' }),
	    _react2.default.createElement(_BattleRow2.default, { type: 'water', cards: props.cardArrays.water }),
	    _react2.default.createElement('hr', { className: 'm-0' }),
	    _react2.default.createElement(_BattleRow2.default, { type: props.type == 'enemy' ? 'land' : 'air',
	...
	PlayingArea.propTypes = {
	  ...
	  cardArrays: _react2.default.PropTypes.object.isRequired
	};
	
	exports.default = PlayingArea;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BattleRow = function (_React$Component) {
	  (0, _inherits3.default)(BattleRow, _React$Component);
	
	  function BattleRow() {
	    (0, _classCallCheck3.default)(this, BattleRow);
	    return (0, _possibleConstructorReturn3.default)(this, (BattleRow.__proto__ || (0, _getPrototypeOf2.default)(BattleRow)).apply(this, arguments));
	  }
	
	  (0, _createClass3.default)(BattleRow, [{
	    key: 'renderCardComponents',
	    value: function renderCardComponents() {
	    ...
	    key: 'render',
	    value: function render() {
	      var content = this.renderCardComponents();
	      return _react2.default.createElement(
	        'div',
	        { className: 'battle-row d-flex flex-wrap justify-content-center px-2 my-1' },
	        content,
	        _react2.default.createElement('div', { className: this.props.type + '-bkgrnd battle-row-type circle' })
	      );
	    }
	  }]);
	  return BattleRow;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".battle-row{min-height:94px;position:relative}.battle-row-type{height:50px;width:50px;position:absolute;right:20px;top:22px}", "", {"version":3,"sources":["/./src/routes/Battle/components/src/routes/Battle/components/BattleRow.scss"],"names":[],"mappings":"AAAA,YACE,gBAAgB,iBACE,CACnB,iBAGC,YAAY,WACD,kBACO,WACP,QACF,CACV","file":"BattleRow.scss","sourcesContent":[".battle-row {\n  min-height: 94px;\n  position: relative;\n}\n\n.battle-row-type {\n  height: 50px;\n  width: 50px;\n  position: absolute;\n  right: 20px;\n  top: 22px;\n}\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CircularProgress = __webpack_require__(583);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _autoPrefix = __webpack_require__(492);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parser = __webpack_require__(590);
	var Manager = __webpack_require__(600);
	var debug = __webpack_require__(587)('socket.io-client');
	...
	exports.Manager = __webpack_require__(600);
	exports.Socket = __webpack_require__(628);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parseuri = __webpack_require__(586);
	var debug = __webpack_require__(587)('socket.io-client:url');
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.humanize = __webpack_require__(589);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(591)('socket.io-parser');
	var json = __webpack_require__(594);
	var Emitter = __webpack_require__(596);
	var binary = __webpack_require__(597);
	var isBuf = __webpack_require__(599);
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function () {
	  ...
	  var isLoader = "function" === "function" && __webpack_require__(595);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var eio = __webpack_require__(601);
	var Socket = __webpack_require__(628);
	var Emitter = __webpack_require__(629);
	var parser = __webpack_require__(590);
	var on = __webpack_require__(631);
	var bind = __webpack_require__(632);
	var debug = __webpack_require__(587)('socket.io-client:manager');
	var indexOf = __webpack_require__(625);
	var Backoff = __webpack_require__(633);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *
	 */
	module.exports.parser = __webpack_require__(610);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var transports = __webpack_require__(604);
	var Emitter = __webpack_require__(618);
	var debug = __webpack_require__(587)('engine.io-client:socket');
	var index = __webpack_require__(625);
	var parser = __webpack_require__(610);
	var parseuri = __webpack_require__(626);
	var parsejson = __webpack_require__(627);
	var parseqs = __webpack_require__(619);
	...
	Socket.Transport = __webpack_require__(609);
	Socket.transports = __webpack_require__(604);
	Socket.parser = __webpack_require__(610);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var XMLHttpRequest = __webpack_require__(605);
	var XHR = __webpack_require__(607);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hasCORS = __webpack_require__(606);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var XMLHttpRequest = __webpack_require__(605);
	var Polling = __webpack_require__(608);
	var Emitter = __webpack_require__(618);
	var inherit = __webpack_require__(620);
	var debug = __webpack_require__(587)('engine.io-client:polling-xhr');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Transport = __webpack_require__(609);
	var parseqs = __webpack_require__(619);
	var parser = __webpack_require__(610);
	var inherit = __webpack_require__(620);
	var yeast = __webpack_require__(621);
	var debug = __webpack_require__(587)('engine.io-client:polling');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hasBinary = __webpack_require__(612);
	var sliceBuffer = __webpack_require__(613);
	var after = __webpack_require__(614);
	var utf8 = __webpack_require__(615);
	
	var base64encoder;
	if (global && global.ArrayBuffer) {
	  base64encoder = __webpack_require__(616);
	}
	...
	var Blob = __webpack_require__(617);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var inherit = __webpack_require__(620);
	var yeast = __webpack_require__(621);
	var debug = __webpack_require__(587)('engine.io-client:websocket');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parser = __webpack_require__(590);
	var Emitter = __webpack_require__(629);
	var toArray = __webpack_require__(630);
	var on = __webpack_require__(631);
	var bind = __webpack_require__(632);
	var debug = __webpack_require__(587)('socket.io-client:socket');
	var hasBin = __webpack_require__(612);
...
//# sourceMappingURL=2.battle.b2ee800913cb10b5df4b.js.map